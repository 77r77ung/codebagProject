...
// 게시글 수정
exports.updateQuestion = 'update question set question_title=?, question_content=?, question_date=?'

// 게시글 삭제
exports.deleteQuestion = 'delete from question where question_uid=?'

// 상세 정보
exports.detailQuestion = 'select * from question where question_uid=?'